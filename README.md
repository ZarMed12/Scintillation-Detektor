...
- Measuring **gamma radiation** (keV–MeV range)
...
### Muons
- Detected as minimum ionizing charged particles
- Require coincidence between two scintillator layers
- High penetration depth

### X-rays & Gamma Rays
- Interact via photoelectric effect and Compton scattering
- Require dense scintillator crystals for efficient absorption
- Enable energy spectrum measurements
